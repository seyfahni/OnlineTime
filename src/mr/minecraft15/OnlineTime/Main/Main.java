...
public class Main extends Plugin {
	...
	public static String getTime(long seconds) {
		...
		String secStr = (sec != 0) ? sec + " " + ((sec == 1) ? Lang.getMessage("Time_Second") : Lang.getMessage("Time_Seconds")) : null, minStr = (min != 0) ? min + " " + ((min == 1) ? Lang.getMessage("Time_Minute") : Lang.getMessage("Time_Minutes")) : null, hStr = (h != 0) ? h + " " + ((h == 1) ? Lang.getMessage("Time_Hour") : Lang.getMessage("Time_Hours")) : null, dStr = (d != 0) ? d + " " + ((d == 1) ? Lang.getMessage("Time_Day") : Lang.getMessage("Time_Days")) : null, wStr = (w != 0) ? w + " " + ((w == 1) ? Lang.getMessage("Time_Week") : Lang.getMessage("Time_Weeks")) : null, mStr = (m != 0) ? m + " " + ((m == 1) ? Lang.getMessage("Time_Month") : Lang.getMessage("Time_Months")) : null, yStr = (y != 0) ? y + " " + ((y == 1) ? Lang.getMessage("Time_Year") : Lang.getMessage("Time_Years")) : null;
		String r = (yStr == null ? "" : yStr + " ") + (mStr == null ? "" : mStr + " ") + (wStr == null ? "" : wStr + " ") + (dStr == null ? "" : dStr + " ") + (hStr == null ? "" : hStr + " ") + (minStr == null ? "" :  minStr + " ") + (secStr == null ? "" : secStr + " ");
